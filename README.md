...
6. **Amazon Snowball**
    ...
    - AWS Snowball is available in two device types. 
      - **Snowball Edge Compute Optimized** - with more computing capabilities, suited for higher performance workloads 
      - **Snowball Edge - Storage Optimized** with more storage, which is suited for large-scale data migrations and capacity-oriented workloads.
...
7. **AMAZON Snowmobile** 
    ...
    - How should I choose between Snowmobile and Snowball? To migrate large datasets of 10 **Petabyte** or more in a single location, you should use Snowmobile. 
...
36. **Notes**
    ...
    - Glacier is a storage service, used for archival storage. Snowball is data transfer service, used for transferring data from your data center or any other source to AWS.
